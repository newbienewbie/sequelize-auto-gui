...
export const DataSourceConfigForm=React.createClass({
    ...
    render:function(){
        ...
        return (<Form horizontal={true}>
            <Form.Item label="数据库地址" {...formItemLayout} >
                <Input onChange={(e)=>{this.genOnChange(e,'host')(e)}} defaultValue={"localhost"}/>
            </Form.Item>
            ...
            <Form.Item label="用户名" {...formItemLayout}>
                <Input onChange={(e)=>{this.genOnChange(e,'user')(e)}} defaultValue={"root"} />
            </Form.Item>
